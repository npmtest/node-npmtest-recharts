...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/shape/Polygon.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/shape/Polygon.js</span></h1>
    <h2>
        
        Statements: <span class="metric">63.64% <small>(42 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/shape/</a> &#187; Polygon.js</div>
</div>
<div class="body">
...
&nbsp;
var getPolygonPoints = <span class="fstat-no" title="function not covered" >function getPolygonPoints(points) {</span>
<span class="cstat-no" title="statement not covered" >  return points.reduce(<span class="fstat-no" title="function not covered" >function (result, entry) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (entry.x === +entry.x &amp;&amp; entry.y === +entry.y) {</span>
<span class="cstat-no" title="statement not covered" >      result.push([entry.x, entry.y]);</span>
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Polygon() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Polygon);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Polygon.__proto__ || Object.getPrototypeOf(Polygon)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var layerClass = (0, _classnames2.default)('recharts-polygon', className);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement('polygon', _extends({}, (0, _ReactUtils.getPresentationAttributes)(this.props), (0, _ReactUtils.filterEventAttributes)(this.props), {</span>
