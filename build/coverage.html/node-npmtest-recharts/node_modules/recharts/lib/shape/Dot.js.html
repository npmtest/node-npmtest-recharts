...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/shape/Dot.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/shape/Dot.js</span></h1>
    <h2>
        
        Statements: <span class="metric">67.21% <small>(41 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">40.91% <small>(18 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">54.55% <small>(6 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">76.67% <small>(23 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/shape/</a> &#187; Dot.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Dot() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Dot);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Dot.__proto__ || Object.getPrototypeOf(Dot)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Dot, [{
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var layerClass = (0, _classnames2.default)('recharts-dot', className);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (cx === +cx &amp;&amp; cy === +cy &amp;&amp; r === +r) {</span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement('circle', _extends({}, (0, _ReactUtils.getPresentationAttributes)(this.props), (0, _ReactUtils.filterEventAttributes)(this.props), {</span>
