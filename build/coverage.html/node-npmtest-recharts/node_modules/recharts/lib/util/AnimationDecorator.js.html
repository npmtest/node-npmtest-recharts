...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/util/AnimationDecorator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/util/AnimationDecorator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.3% <small>(38 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/util/</a> &#187; AnimationDecorator.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function AnimationDecorator() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, AnimationDecorator);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AnimationDecorator.__proto__ || Object.getPrototypeOf(AnimationDecorator)).call.apply(_ref, [this].concat(args))), _this), _this.state = {</span>
        animationId: 0
...
<span class="cstat-no" title="statement not covered" >        var animationId = this.state.animationId;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.props.data !== nextProps.data) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { animationId: this.state.animationId }));</span>
      }
    }]);
&nbsp;
