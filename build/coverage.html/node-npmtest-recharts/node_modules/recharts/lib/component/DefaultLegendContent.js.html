...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/component/DefaultLegendContent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/component/DefaultLegendContent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">54.12% <small>(46 / 85)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">51.85% <small>(28 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/component/</a> &#187; DefaultLegendContent.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function DefaultLegendContent() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, DefaultLegendContent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (DefaultLegendContent.__proto__ || Object.getPrototypeOf(DefaultLegendContent)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
     ...
     */
    value: <span class="fstat-no" title="function not covered" >function renderIcon(data) {</span>
<span class="cstat-no" title="statement not covered" >      var color = data.color;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var halfSize = SIZE / 2;</span>
<span class="cstat-no" title="statement not covered" >      var sixthSize = SIZE / 6;</span>
<span class="cstat-no" title="statement not covered" >      var thirdSize = SIZE / 3;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (data.type === 'line') {</span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement('path', {</span>
          strokeWidth: 4,
          fill: 'none',
          stroke: color,
      ...
      } else <span class="cstat-no" title="statement not covered" >if (data.type === 'rect') {</span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement('path', {</span>
          stroke: 'none',
          fill: color,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(_Symbols2.default, {</span>
        fill: color,
        cx: halfSize,
        cy: halfSize,
        size: SIZE,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var viewBox = { x: 0, y: 0, width: SIZE, height: SIZE };</span>
<span class="cstat-no" title="statement not covered" >      var itemStyle = {</span>
        display: layout === 'horizontal' ? 'inline-block' : 'block',
        marginRight: 10
      };
<span class="cstat-no" title="statement not covered" >      var svgStyle = { display: 'inline-block', verticalAlign: 'middle', marginRight: 4 };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return payload.map(<span class="fstat-no" title="function not covered" >function (entry, i) {</span></span>
<span class="cstat-no" title="statement not covered" >        var finalFormatter = entry.formatter || formatter;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (entry.type === 'none') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var finalStyle = {</span>
        padding: 0,
        margin: 0,
