...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/shape/Cross.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/shape/Cross.js</span></h1>
    <h2>
        
        Statements: <span class="metric">67.74% <small>(42 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/shape/</a> &#187; Cross.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Cross() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Cross);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Cross.__proto__ || Object.getPrototypeOf(Cross)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Cross, [{
    key: 'getPath',
    value: <span class="fstat-no" title="function not covered" >function getPath(x, y, width, height, top, left) {</span>
<span class="cstat-no" title="statement not covered" >      return 'M' + x + ',' + top + 'v' + height + 'M' + left + ',' + y + 'h' + width;</span>
    }
  }, {
    key: 'render',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!(0, _DataUtils.isNumber)(x) || !(0, _DataUtils.isNumber)(y) || !(0, _DataUtils.isNumber)(width) || !(0, _DataUtils.isNumber)(height) || !(0, _DataUtils.isNumber)(top) || !(0, _DataUtils.isNumber)(left)) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement('path', _extends({}, (0, _ReactUtils.getPresentationAttributes)(this.props), {</span>
