...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-recharts/node_modules/recharts/lib/component/DefaultTooltipContent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-recharts/node_modules/recharts/lib/component/DefaultTooltipContent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">56.41% <small>(44 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-recharts/node_modules/recharts/lib/component/</a> &#187; DefaultTooltipContent.js</div>
</div>
<div class="body">
...
&nbsp;
var defaultFormatter = <span class="fstat-no" title="function not covered" >function defaultFormatter(value) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _isArray3.default)(value) &amp;&amp; (0, _DataUtils.isNumOrStr)(value[0]) &amp;&amp; (0, _DataUtils.isNumOrStr)(value[1]) ? value.join(' ~ ') : value;</span>
};
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function DefaultTooltipContent() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, DefaultTooltipContent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (DefaultTooltipContent.__proto__ || Object.getPrototypeOf(DefaultTooltipContent)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (payload &amp;&amp; payload.length) {</span>
<span class="cstat-no" title="statement not covered" >        var listStyle = { padding: 0, margin: 0 };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var items = payload.filter(<span class="fstat-no" title="function not covered" >function (entry) {</span></span>
<span class="cstat-no" title="statement not covered" >          return !(0, _isNil3.default)(entry.value);</span>
        }).sort(itemSorter).map(<span class="fstat-no" title="function not covered" >function (entry, i) {</span>
<span class="cstat-no" title="statement not covered" >          var finalItemStyle = _extends({</span>
            display: 'block',
            paddingTop: 4,
            paddingBottom: 4,
            color: entry.color || '#000'
          }, itemStyle);
<span class="cstat-no" title="statement not covered" >          var finalFormatter = entry.formatter || formatter || defaultFormatter;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var finalStyle = _extends({</span>
        margin: 0,
        padding: 10,
        backgroundColor: '#fff',
...
<span class="cstat-no" title="statement not covered" >      var finalLabelStyle = _extends({</span>
        margin: 0
      }, labelStyle);
<span class="cstat-no" title="statement not covered" >      var hasLabel = (0, _DataUtils.isNumOrStr)(label);</span>
<span class="cstat-no" title="statement not covered" >      var finalLabel = hasLabel ? label : '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (hasLabel &amp;&amp; labelFormatter) {</span>
<span class="cstat-no" title="statement not covered" >        finalLabel = labelFormatter(label);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        'div',
